...
##### 查看测试结果
![](/uploads/image/reference/ClassLoadTestResult1.jpg)
**结论：从结果中可以看出，虽然是同一份class字节码文件，但是由于被两个不同的ClassLoader实例所加载，所以JVM认为它们就是两个不同的类。**

##### ClassLoader的体系架构：
<center>
![](/uploads/image/reference/ClassLoader.png)
</center>
...
***打印结果：***
![](/uploads/image/reference/ClassLoaderResult2.jpg)

下图是web服务器的目录结构：
![](/uploads/image/reference/ClassLoaderTestResult3.jpg)
...
4、访问Servlet，获得显示结果
![](/uploads/image/reference/ClassLoaderTestResult4.jpg)
